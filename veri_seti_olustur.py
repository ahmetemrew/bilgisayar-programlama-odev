...
def karakter_resmi_olustur(
    ...
    resim = Image.new("L", (YUKSEKLIK, YUKSEKLIK), 255)
    ...
    x = (YUKSEKLIK - metin_genisligi) // 2 - sol + x_kayma
    y = (YUKSEKLIK - metin_yuksekligi) // 2 - ust + y_kayma
    ...
    if egiklik != 0:
        kayma = int(abs(egiklik) * YUKSEKLIK)
